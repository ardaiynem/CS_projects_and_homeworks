...
HD_PWD='C:/Users/innsolit/mips_hopeless/mips_hopeless.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log boardModule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source boardModule.tcl -notrace
