...
HD_PWD='C:/Users/innsolit/mips_hopeless/mips_hopeless.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log boardModule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source boardModule.tcl
