...
HD_PWD='C:/Users/innsolit/traffic_lights_fsm/traffic_lights_fsm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_module.vdi -applog -m64 -messageDb vivado.pb -mode batch -source fsm_module.tcl -notrace
