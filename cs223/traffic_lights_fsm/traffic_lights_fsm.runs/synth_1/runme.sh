...
HD_PWD='C:/Users/innsolit/traffic_lights_fsm/traffic_lights_fsm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_module.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fsm_module.tcl
