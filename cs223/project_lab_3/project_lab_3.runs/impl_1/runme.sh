...
HD_PWD='C:/Users/innsolit/project_lab_3/project_lab_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log function_f.vdi -applog -m64 -messageDb vivado.pb -mode batch -source function_f.tcl -notrace
