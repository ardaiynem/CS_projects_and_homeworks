...
HD_PWD='C:/Users/innsolit/project_lab_3/project_lab_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log function_f.vds -m64 -mode batch -messageDb vivado.pb -notrace -source function_f.tcl
